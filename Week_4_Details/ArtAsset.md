...
| ----------------- | -------------- | ----------------------------------------------------------------------------------------------------------- |
| **bg_sunny**      | 1920x1080      | Clear weather with a pleasant, ethereal, and dreamlike atmosphere.                                          |
...
| **Asset Name**  | **Dimensions** | **Formal Description**                                           |
| --------------- | -------------- | ---------------------------------------------------------------- |
| **bg_game_end** | N/A            | Background reserved for placement of end-game iconography.       |
...
| **Asset Name**                | **Dimensions** | **Formal Description**                                          |
| ----------------------------- | -------------- | --------------------------------------------------------------- |
| **obstacle_promoter**         | 120x220        | An NPC actively distributing promotional flyers.                |
