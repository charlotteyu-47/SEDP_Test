...
1. promoter
   ...
   ![image](https://github.com/user-attachments/assets/4246bf1d-bf68-4f04-a6fe-cc3368e8bbf0)
   但是在实际操作中不确定制作难度和传单在屏幕上时间够不够体现这个效果<br>
   		连按大于等于15下空格后团成纸团<br>
		大约需要3-5张素材，  
			1.平整   
			2.揉皱剩下3/4的体积，按5下空格的效果<br>   
			3.剩下1/2体积, 按5下空格的效果<br> 
			4. 纸团，按5下空格的效果<br>
			5. 纸团和障碍物碰撞效果<br>
